...
# El backend de Express está en el puerto 5000, no en 3000 (que es el frontend/nginx)
...
def test_visualizar_factura_sql_injection(payload):
    ...
    # Verificar que el servidor rechace el payload malicioso
    # El backend con validación debe devolver 400 (Bad Request) para IDs inválidos
    # El backend sin validación devuelve 200 (acepta el payload) o 500 (error SQL)
